...
public class FlowHandler<LogicHandler, ConcreteFlow> {
    
    var next: FlowHandler?
    let concreteFlow: ConcreteFlow
    let logicHandler: LogicHandler
    
    public init(
        _ logicHandler: LogicHandler,
        concreteFlow: ConcreteFlow) {
        
        self.logicHandler = logicHandler
        self.concreteFlow = concreteFlow
    }
